        ...
        <div class="col">
            <blockquote class="instagram-media" data-instgrm-permalink="{{ $data['homepage']->ig1 }}">
                <div style="padding:16px;">
                    ...
                    <p style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; line-height:17px; margin-bottom:0; margin-top:8px; overflow:hidden; padding:8px 0 7px; text-align:center; text-overflow:ellipsis; white-space:nowrap;"><a href="https://www.instagram.com/p/CXCWZLEB-D4/?utm_source=ig_embed&amp;utm_campaign=loading" style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; font-style:normal; font-weight:normal; line-height:17px; text-decoration:none;" target="_blank">Sebuah kiriman dibagikan oleh Uniqlass (@uniqlass)</a></p>
                </div>
            </blockquote>
        ...
        <div class="col d-none d-sm-block">
            <blockquote class="instagram-media" data-instgrm-permalink="{{ $data['homepage']->ig2 }}">
                <div style="padding:16px;">
                    ...
                    <p style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; line-height:17px; margin-bottom:0; margin-top:8px; overflow:hidden; padding:8px 0 7px; text-align:center; text-overflow:ellipsis; white-space:nowrap;"><a href="https://www.instagram.com/p/CWDJlHRBZdw/?utm_source=ig_embed&amp;utm_campaign=loading" style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; font-style:normal; font-weight:normal; line-height:17px; text-decoration:none;" target="_blank">Sebuah kiriman dibagikan oleh Uniqlass (@uniqlass)</a></p>
                </div>
            </blockquote>
            <script async src="//www.instagram.com/embed.js"></script>
        </div>
        <div class="col d-none d-xl-block">
            <blockquote class="instagram-media" data-instgrm-permalink="{{ $data['homepage']->ig3 }}">
                <div style="padding:16px;">
                    ...
                    <p style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; line-height:17px; margin-bottom:0; margin-top:8px; overflow:hidden; padding:8px 0 7px; text-align:center; text-overflow:ellipsis; white-space:nowrap;"><a href="https://www.instagram.com/p/CV0cVmFBqkM/?utm_source=ig_embed&amp;utm_campaign=loading" style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; font-style:normal; font-weight:normal; line-height:17px; text-decoration:none;" target="_blank">Sebuah kiriman dibagikan oleh Uniqlass (@uniqlass)</a></p>
                </div>
            </blockquote>
            <script async src="//www.instagram.com/embed.js"></script>
        </div>
                ...
                <div class="col-lg-4 col-md-6 pb-5">
                    <div class="card" style="width: 18rem; height: 30rem;">
                        ...
                        <div class="card-body">
                            ...
                            <a type="button" class="btn btn-success mt-5" href="{{ route('event.show', Str::slug($evt->judul_event)) }}">Selengkapnya</a>
                        </div>
                    </div>
                </div>
                @else
